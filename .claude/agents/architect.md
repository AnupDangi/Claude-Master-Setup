...
6. Record the outcome as an ADR appended to `.master/docs/DECISIONS.md` using the template already in that file: context, options considered, decision, consequences, and status. For bootstrap, also note the accepted **build_effort_tier**.
